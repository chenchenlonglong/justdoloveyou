...
class IndexController extends  Controller
{
    public  function  actionIndex(){
        ...
        +-----------------------------------------------------------------------------
         */
    public    function actionInfo($proxy_ip=false, $times=10) {
            $header = array(
                // "GET / HTTP/1.1",
                // "HOST: www.baidu.com",
    ...
    public  function  actionGet_session(){
        ...
        $session->set("chenlong","chenlong");
        var_dump($session->get("chenlong"));

        //session存数组的时候,存相同的键名
        $session["chenlong.1"]=300;
        $session["chenlong.2"]=300;
        $session["chenlong.3"]=300;
        $session["chenlong.4"]=310;

        var_dump($session["chenlong.4"]);
